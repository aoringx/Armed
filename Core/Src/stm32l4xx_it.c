...
uint8_t wii_ir_data[12]; // Define Global Data Structure that Stores Wii_IR_Data
/* USER CODE END TD */
...
void TIM5_IRQHandler(void)
{
  /* USER CODE BEGIN TIM5_IRQn 0 */
	// Reads Wii_IR Data
	  ...
	  HAL_I2C_Master_Receive(&hi2c1, IR_R_M, &wii_ir_data[0], 12, 1000);
	  // Stores data into global variable wii_ir_data[12]
