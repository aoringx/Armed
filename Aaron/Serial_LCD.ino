...
{ 
  ...
  initLCD_I2C(5, 4);
  // initLCD_SPI(A5, A4, A3);
  //initLCD_RS232(2);

  setContrast(0x30);

  writeString((unsigned char*)"We're Armed");
  setCursor(0x40);
  writeString((unsigned char*)"We make autoaim guns");
  setCursor(0x14);
  writeString((unsigned char*)"It's fking awesome");
  setCursor(0x54);
  writeString((unsigned char*)"We rock");
}
